...
export const PROJECTS: Project[] = [
  { id: 1, slug: "choose-your-starter", title: "Choose Your Starter!", category: "Side project", year: "2025", color: "#b3b3c1", desc: "A website that displays information and some fun facts on the first generation Pokémon starters, built with standard HTML5 and CSS. The purpose of this website was for me to sharpen my frontend skills and experiment with new CSS tricks. You can find the project https://jacobhella.github.io/pokemon_starters/", images: [
...
export const EXPERIENCES: Experience[] = [
  ...
  { id: 3, role: "Master's Degree in Interaction Technology and Design", company: "Umeå University", startDate: "2021-08", endDate: "2026-06", description: "Learned how to create applications and digital services with a focus on usability and user experience. In my education, I've also had project-based courses that focused on real-world product and service development." },
  { id: 4, role: "Exchange Student in Phoenix", company: "Arizona School of the Arts", startDate: "2018-07", endDate: "2019-06", description: "Completed an exchange year during high school in Phoenix, Arizona. In Phoenix, I studied English, Spanish, music composition, and mathematics. Arizona was a great experience and it really helped me to master my skills in English." },
  { id: 5, role: "Mentor in Mathematics", company: "Umeå University", startDate: "2022-08", endDate: "2022-09", description: "Worked as a mentor in mathematics at Umeå University on the course Introductory Algebra (5MA173). The course is a week-long introduction course for newly enrolled engineering students. I was responsible for facilitating classes of 15 students and supervised a test and the end of the course. Developed strong communication and public speaking skills through daily teaching, and practiced adapting explanations to students within the group." },
].sort((a, b) => {
